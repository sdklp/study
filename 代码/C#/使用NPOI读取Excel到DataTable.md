...
![img](https://img-blog.csdn.net/20160823171708160)

三.下面是我需要的读取的Excel文件，数据格式如下：

![img](https://img-blog.csdn.net/20160823171840287)
...
for (j = 0; j < data.Columns.Count; ++j) 
{ 
row.CreateCell(j).SetCellValue(data.Rowsi.ToString()); 
} 
++count; 
} 
...
![img](https://img-blog.csdn.net/20160823172332918)